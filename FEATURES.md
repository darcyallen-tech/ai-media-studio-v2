...
| **I2I** | Edit one still | Flux 2 Pro / Max / Flex, MAI-Image-2.5 Pro / 2.5, Nano Banana Pro / 2, Flux Kontext Pro, Grok Imagine Edit / Quality Edit / 2.0 Edit, Qwen Image 3, Seedream 5.0 Pro, **Fibo Edit 1.5** (multi-ref, default Fibo), Fibo Edit v1 (optional mask) |
