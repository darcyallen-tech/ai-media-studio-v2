...
Photoreal checkbox (default on) injects the photo lock; Enhance strips painterly/cinematic/volumetric/concept unless the user typed them; off sends no lock.
