...
_MODEL_ALIASES: dict[str, str] = {
    ...
    "qwen image 3 t2i": "qwen-image-3-t2i",
    "qwen image 3 i2i": "qwen-image-3-edit",
    "qwen image 3 r2i": "qwen-image-3-r2i",
    "recraft v4 t2i": "recraft-v4-t2i",
    "recraft v3 t2i": "recraft-v3-t2i",
    "kling v3 pro t2v": "kling-v3-pro-t2v",
    "kling v3 standard t2v": "kling-v3-std-t2v",
    "kling o3 pro t2v": "kling-o3-pro-t2v",
    "kling o3 standard t2v": "kling-o3-std-t2v",
    "sync 3 lipsync": "sync-3-lipsync",
    "topaz wonder": "topaz-wonder",
    "flux video upscale": "flux-video-upscale",
    "topaz starlight gen": "topaz-starlight-gen",
    "topaz recovery": "topaz-recovery",
    "flux 2 pro": "flux-2-pro",
    "flux 2 flex": "flux-2-flex",
    "flux 2 max": "flux-2-max",
    "gpt image 2.5 flare": "gpt-image-2.5-flare",
    "gpt image 2.5 flare t2i": "gpt-image-2.5-flare-t2i",
    "gpt image 2.5 flare i2i": "gpt-image-2.5-flare-i2i",
    "gpt image 2.5 flare r2i": "gpt-image-2.5-flare-r2i",
    "gpt image 2.5 sunburst": "gpt-image-2.5-sunburst",
    "gpt image 2.5 sunburst t2i": "gpt-image-2.5-sunburst-t2i",
    "gpt image 2.5 sunburst i2i": "gpt-image-2.5-sunburst-i2i",
    "gpt image 2.5 sunburst r2i": "gpt-image-2.5-sunburst-r2i",
    ...
    "kling o3 4k edit": "kling-o3-4k-v2v",
    "kling o3 4k reference": "kling-o3-4k-ref",
    "minimax h3 max reference": "h3-max-r2v",
    "minimax h3 max omni": "h3-max-r2v",
    ...
    "elevenlabs music v2.5": "el-music-v2.5",
    ...
    "luma ray 3.2": "luma-ray32",
    "muse image t2i": "muse-t2i",
    "muse image edit": "muse-edit",
    "muse image edit i2i": "muse-edit",
    "muse image edit r2i": "muse-r2i",
    "minimax h3 max t2v": "h3-max-t2v",
    "minimax h3 max i2v": "h3-max-i2v",
    "minimax h3 max turbo t2v": "h3-max-turbo-t2v",
    "minimax h3 max turbo i2v": "h3-max-turbo-i2v",
    "minimax h3 max turbo bridge": "h3-max-turbo-bridge",
    "gemini omni 1.1 t2v": "gemini-omni-t2v",
    "gemini omni 1.1 i2v": "gemini-omni-i2v",
    "gemini omni 1.1 reference": "gemini-omni-r2v",
    "gemini omni 1.1 edit": "gemini-omni-edit",
    "minimax speech 2.6 hd": "minimax-speech-26",
    "minimax speech 2.8 hd": "minimax-speech-28",
    "kling o3 pro i2v": "kling-o3-pro-i2v",
    "seedance 2.0 i2v": "seedance-2-i2v",
