...
IMAGE_EDIT_MODELS: dict[str, ImageEditModelSpec] = {
    ...
    "gpt image 2.5 flare": ImageEditModelSpec(
        ...
        label="Image · GPT Image 2.5 Flare (quality / speed)",
        ...
        resolution_param=None,
        image_size_param="image_size",
        allowed_resolutions=("auto", "low", "medium", "high", "xhigh", "max"),
        default_resolution="high",
        max_resolution="",
        default_output_format="png",
        cost_per_image=0.24,
        resolution_cost_mult={
            "AUTO": 1.0,
            "HIGH": 1.0,
            "MEDIUM": 0.25,
            "LOW": 0.03,
        ...
        notes=(
            ...
            "Token-billed; est. ~$0.24 @ high."
        ),
    ),
    "gpt image 2.5 sunburst": ImageEditModelSpec(
        key="gpt image 2.5 sunburst",
        label="Image · GPT Image 2.5 Sunburst (precision / multi-round edit)",
        ...
        notes=(
            ...
            "Up to 16 image_urls. Same token price as Flare. "
...
_ALIASES: dict[str, str] = {
    ...
    "openai/gpt-image-2.5/flare/edit": "gpt image 2.5 flare",
    "openai/gpt-image-2.5/flare/text-to-image": "gpt image 2.5 flare",
    "gpt image 2.5 sunburst": "gpt image 2.5 sunburst",
    "gpt image 2.5 sunburst (edit)": "gpt image 2.5 sunburst",
    "image · gpt image 2.5 sunburst (precision / multi-round edit)": "gpt image 2.5 sunburst",
